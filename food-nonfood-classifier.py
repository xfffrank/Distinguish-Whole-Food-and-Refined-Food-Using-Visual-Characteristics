# -*- coding: utf-8 -*-
"""Food / Non-Food code re-construction.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CmgZEpqOZ0ME3zJToeucD4ZFJatl8tqn
"""
...
def create_model(base, num_of_layers, input_sz=None):
    '''
...
def train_model(model, train_generator, eval_generator, callbacks_list, ep=5):
...
collection = {
    'mobileNet-v2': {
        ...
        'last_layers': 1,  # choice: 1, 5
        'batch_sz': 32,
        'target_sz': (256, 256),  # used for loading images
        'input_sz': (256, 256, 3), # used for building a model
        'file_path': 'drive/My Drive/MSc dataset/food5k/Food-5K/models/mobileNet_v2_last_1_256.best.hdf5',
        'epoch': 5
    },
    'inception-v3': {
        'preprocess_func': inception_v3.preprocess_input,
        'base_model': InceptionV3,
        'last_layers': 1,  # choice: 1, 14
        'batch_sz': 32,
        'target_sz': (256, 256),  # used for loading images
        'input_sz': (256, 256, 3), # used for building a model
        'file_path': 'drive/My Drive/MSc dataset/food5k/Food-5K/models/inception_v3_last_1_256_without_aug.best.hdf5',
        'epoch': 5
    },
    'resnet50': {
        'preprocess_func': resnet50.preprocess_input,
        'base_model': ResNet50,
        'last_layers': 6,  # choice: 1, 6
        'batch_sz': 32,
        'target_sz': (256, 256),  # used for loading images
        'input_sz': (256, 256, 3), # used for building a model
        'file_path': 'drive/My Drive/MSc dataset/food5k/Food-5K/models/resnet50_last_6_256.best.hdf5',
        'epoch': 5
    }
}

train_path = "drive/My Drive/MSc dataset/food5k/Food-5K/training"
eval_path = "drive/My Drive/MSc dataset/food5k/Food-5K/validation"
test_path = "drive/My Drive/MSc dataset/food5k/Food-5K/evaluation"

"""**Before each run for a new model, change the file path.**"""

run_model(collection['inception-v3'], train_path, eval_path, test_path, train=False, test=True)